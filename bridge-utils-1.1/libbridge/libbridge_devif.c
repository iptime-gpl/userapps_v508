...
#ifdef USE_PORT_BASED_VLAN_IN_BRIDGE
int br_set_port_map(const char *bridge, const char *port, int port_map)
{
	return port_set(bridge, port, "port_map", port_map, BRCTL_SET_PORT_MAP);
}
#endif
