...
**
** $Id: si3217x_revb_intf.c,v 1.1.1.1 2016/11/01 07:34:28 hyrtlac Exp $
**
** SI3217X_RevB_Intf.c
 ...
 ramData ram_data;
    ...
    case INIT_SEQ_PRE_CAL:
...
#ifdef REALTEK_PATCH_FOR_SILAB
		//WriteRAM(pProHW, pProslic->channel,SI3217X_COM_RAM_VBAT_TRACK_MIN_RNG, 0x01893740L);//Si3217x_General_Configuration.vbat_track_min_rng);
#else		
        ...
        */
        ...
        ram_data *= BIT20LSB;
#ifdef REALTEK_PATCH_FOR_SILAB
        WriteRAM(pProHW, pProslic->channel,SI3217X_COM_RAM_DCDC_OITHRESH,0x00500000L);
#else		
        ...
        ram_data *= BIT20LSB;
#ifdef REALTEK_PATCH_FOR_SILAB
        WriteRAM(pProHW, pProslic->channel,SI3217X_COM_RAM_DCDC_OVTHRESH,0x00B00000L);
#else		
        ...
        ram_data *= BIT20LSB;
#ifdef REALTEK_PATCH_FOR_SILAB
        WriteRAM(pProHW, pProslic->channel,SI3217X_COM_RAM_DCDC_UVTHRESH,0x00200000L);
#else		
        ...
        ram_data *= BIT20LSB;
#ifdef REALTEK_PATCH_FOR_SILAB
        WriteRAM(pProHW, pProslic->channel,SI3217X_COM_RAM_DCDC_UVHYST,0x00100000L);
#else		
...
ramData inv_off;
    ...
    case BO_DCDC_PMOS_BUCK_BOOST:
        ...
        ** non-inverted polarity, and dcff drive on low voltage option only (deprecated)
        */
        WriteRAM(pProHW, pProslic->channel,SI3217X_COM_RAM_DCDC_DCFF_ENABLE,0x0L);
        WriteRAM(pProHW, pProslic->channel,SI3217X_REVB_RAM_DCDC_SWFET,0x300000L);
        WriteRAM(pProHW, pProslic->channel,SI3217X_COM_RAM_DCDC_SWDRV_POL,inv_off);
