...
**
** $Id: si3217x_revc_intf.c,v 1.1.1.1 2016/11/01 07:34:28 hyrtlac Exp $
**
** SI3217X_RevC_Intf.c
 ...
 ramData ram_data;
    ...
    case INIT_SEQ_PRE_CAL:
        ...
        */
        ...
        if(Si3217x_General_Configuration.bom_option == BO_DCDC_LCQCUK)  
        {
...
int Si3217x_RevC_SelectPatch(proslicChanType_ptr pProslic, const proslicPatch **patch)
{
    ...
    else if(Si3217x_General_Configuration.bom_option == BO_DCDC_LCQCUK)
    {
