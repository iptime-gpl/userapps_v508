 ...
 *
 * $Revision: 1.1.1.1 $
 * $LastChangedDate: 2014-03-20 11:18:04 -0500 (Thu, 20 Mar 2014) $
 */
...
typedef enum VpSignalingEventType {
    ...
    /**< VP_DEV_EVID_SEQUENCER
     *  This event is not officially published as part of the VP-API-II interface, but it's used
     * to trigger Application copy of the line and device objects for system switchover purpose.
     * It is conceivable to be useful in a variety of other ways for ZL880 and CSLAC devices since
     * it's an indication of host level activity.
     * Conclusion: Do Not Remove This Event!
     */
