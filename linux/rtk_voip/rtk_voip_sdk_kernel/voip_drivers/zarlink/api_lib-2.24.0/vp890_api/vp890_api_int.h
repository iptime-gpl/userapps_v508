...
#define VP890_VOC_MIN           12000L
#define VP890_VOC_MAX           57000L
#define VP890_VOC_OFFSET        12000L
#define VP890_VOC_HIGH_OFFSET   36000L
#define VP890_VOC_STEP          3000L

/* ILA is a 5-bit value with a 18-49 mA scale (1 mA per step + 18 mA
   offset) */
#define VP890_ILA_MIN           18000L
#define VP890_ILA_MAX           49000L
#define VP890_ILA_OFFSET        18000L
#define VP890_ILA_STEP          1000L

/* TSH is a 3-bit value with a 8-15 mA scale (1 mA per step + 8 mA
   offset) */
#define VP890_TSH_MIN           8000L
#define VP890_TSH_MAX           15000L
#define VP890_TSH_OFFSET        8000L
#define VP890_TSH_STEP          1000L

/* TGK is a 3-bit value with a 0-42 mA scale (6 mA per step) */
#define VP890_TGK_MIN           0L
#define VP890_TGK_MAX           42000L
#define VP890_TGK_OFFSET        0L
#define VP890_TGK_STEP          6000L

/* Allow battery floor voltage from -5 to -100 V in 5V steps */
#define VP890_BATTFLR_MIN       -100000L
#define VP890_BATTFLR_MAX       -5000L
#define VP890_BATTFLR_OFFSET    -5000L
#define VP890_BATTFLR_STEP      -5000L
...
#define VP890_FREQ_MIN          0L
#define VP890_FREQ_MAX          12000000L
#define VP890_FREQ_STEP_NUM     46875L
#define VP890_FREQ_STEP_DEN     0x80L
...
#define VP890_TRAPFREQ_MIN      244L
#define VP890_TRAPFREQ_MAX      8000000L

/* Amplitude is a 16-bit value with a +/- 155V range.  This
   means 155000 mV per 0x8000, which reduces to 19375 mV per 0x1000. */
#define VP890_AMP_MIN           -155000L
#define VP890_AMP_MAX           155000L
#define VP890_AMP_STEP_NUM      19375L
#define VP890_AMP_STEP_DEN      0x1000L

/* DC Bias is a 16-bit value with a +/- 154.4V range.  This
   means 154400 mV per 0x8000, which reduces to 4825 mV per 0x400. */
#define VP890_BIAS_MIN          -154400L
#define VP890_BIAS_MAX          154400L
#define VP890_BIAS_STEP_NUM     4825L
#define VP890_BIAS_STEP_DEN     0x400L

/* Ring trip threshold is a 7-bit value with a 0-63.5 mA scale (0.5 mA
   per step). */
#define VP890_RTTH_MIN          0L
#define VP890_RTTH_MAX          63500L
#define VP890_RTTH_OFFSET       0L
#define VP890_RTTH_STEP         500L

/* Ring current limit is a 5-bit value with a 50-112 mA scale (2 mA per
   step + 50 mA offset). */
#define VP890_ILR_MIN           50000L
#define VP890_ILR_MAX           112000L
#define VP890_ILR_OFFSET        50000L
#define VP890_ILR_STEP          2000L
...
#define VP890_TRAPRISE_MIN      83L
#define VP890_TRAPRISE_MAX      2730700L
