 ...
 *
 * $Revision: 1.1.1.1 $
 * $LastChangedDate: 2013-07-18 16:30:44 -0500 (Thu, 18 Jul 2013) $
 */
    ...
    const uint8 *pDataBuf)
{
    ...
    /* Explicit EC_WRT commands should not be allowed */
    if (cmd == VP886_R_EC_WRT) {
        VP_WARNING(VpDevCtxType, pDevCtx, ("Invalid EC_WRT command in Vp886SlacRegWrite (0x%02X)", cmd));
        return FALSE;
    }
