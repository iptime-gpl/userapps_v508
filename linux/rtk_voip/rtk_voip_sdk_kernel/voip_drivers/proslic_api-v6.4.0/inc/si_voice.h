...
**
** $Id: si_voice.h,v 1.1.1.1 2016/11/01 07:34:28 hyrtlac Exp $
**
** si_voice.h
**
** Author(s): 
...
typedef enum {
	...
	BO_DCDC_P_BUCK_BOOST_12V, /**< DC power supply: pmos buck-boost 12v design */
    BO_DCDC_P_BUCK_BOOST_12V_HV, /**< DC power supply: higher voltage version of BO_DCDC_P_BUCK_BOOST_12V */
	BO_DCDC_CUK              /**< DC power supply:  full cuk design */
} bomOptionsType;
