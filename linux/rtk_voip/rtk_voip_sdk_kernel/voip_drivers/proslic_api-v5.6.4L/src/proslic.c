...
#endif
#ifdef CONFIG_RTK_VOIP_DRIVERS_SLIC_SI3226 // changed by Joshua 2011.05.17
#define SI322X
#include "si3226.h"
#include "si3226_intf.h"
#include "si3226_userdef.h" // add by Joshua 2011.05.17
#endif
#ifdef CONFIG_RTK_VOIP_DRIVERS_SLIC_SI3217x // changed by Joshua 2011.05.17
#define SI3217X
#include "si3217x.h"
#include "si3217x_intf.h"
#include "si3217x_userdef.h" //add by Joshua 2011.05.17
#endif
#ifdef CONFIG_RTK_VOIP_DRIVERS_SLIC_SI3226x // changed by Joshua 2011.05.17
#define SI3226X
#include "si3226x.h"
...
#ifdef SI3220
	if (hProslic->deviceId->chipType >= SI3220 && hProslic->deviceId->chipType <= SI3225)
		return Si3220_DisableInterrupts(hProslic);
#endif
#ifdef SI3217X
	if (hProslic->deviceId->chipType >= SI32171 && hProslic->deviceId->chipType <= SI32179)
...
#ifdef SI3226X
	if (pProslic->deviceId->chipType >= SI32260 && pProslic->deviceId->chipType <= SI32269)
		Si3226x_Set_Ring_Cadence_ON(pProslic, msec);
#endif
	return 1;
...
#ifdef SI3226X
	if (pProslic->deviceId->chipType >= SI32260&& pProslic->deviceId->chipType <= SI32269)
		Si3226x_Set_Ring_Cadence_OFF(pProslic, msec);
#endif
	return 1;
}
