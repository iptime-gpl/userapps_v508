...
**
** $Id: si3226_userdef.c,v 1.1.1.1 2016/11/01 07:34:28 hyrtlac Exp $
**
** SI322X_Intf.c
...
unsigned int Si3226_SendNTTCAR_check(unsigned int ch_id, proslicChanType *pProslic, unsigned long time_out)
{
	//int protect_cnt = 0;
	int i;
#ifdef CONFIG_RTK_VOIP_IPC_ARCH_IS_HOST
