...
#if defined(CONFIG_RTL_8367R_SUPPORT) || defined(CONFIG_RTL_8211F_SUPPORT) || defined(CONFIG_RTL_83XX_SUPPORT) || defined(CONFIG_RTL_8309M_SUPPORT)
...
#define BSP_WL2G_LED_PIN                BSP_GPIO_PIN_E1
#define BSP_WL5G_LED_PIN                BSP_GPIO_PIN_E2
#else
#define BSP_WL2G_LED_PIN                BSP_GPIO_PIN_E3
#define BSP_WL5G_LED_PIN                BSP_GPIO_PIN_E1
#endif
#endif

#ifdef CONFIG_EFM_EXTENDER_GIGA
#define BSP_5G_BEST_PIN			BSP_GPIO_PIN_E0
#define BSP_5G_GOOD_PIN			BSP_GPIO_PIN_D7
#define BSP_5G_LOW_PIN			BSP_GPIO_PIN_D6
#define BSP_5G_BAD_PIN			BSP_GPIO_PIN_D5
#define BSP_2G_BEST_PIN			BSP_GPIO_PIN_D4
#define BSP_2G_GOOD_PIN			BSP_GPIO_PIN_D3
#define BSP_2G_LOW_PIN			BSP_GPIO_PIN_D2
#define BSP_2G_BAD_PIN			BSP_GPIO_PIN_D1
#define BSP_WPS_BTN_2G_PIN		BSP_GPIO_PIN_H0
#define BSP_WPS_BTN_5G_PIN		BSP_GPIO_PIN_C6
#endif

#ifdef CONFIG_EFM_RING_GIGA
#define BSP_RED_LED_PIN                BSP_GPIO_PIN_H1
#define BSP_BLUE_LED_PIN                BSP_GPIO_PIN_D7
#endif
...
#define BSP_8367R_RST_PIN               BSP_GPIO_PIN_H5
#else
...
/* LED devices */
#ifdef CONFIG_EFM_PATCH
static struct rtl819x_gpio_platdata rtl_pdata_led2g = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "led2g",
};

static struct rtl819x_gpio_platdata rtl_pdata_led5g = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "led5g",
};
#if !defined(CONFIG_SERIAL_RTL_UART1_PINMUX1)
static struct platform_device rtl_led_dev2g = {
        .name           = "rtl819x_led",
        .id                     = 3,
        .dev            = {
                .platform_data = &rtl_pdata_led2g
        },
};
static struct platform_device rtl_led_dev5g = {
        .name           = "rtl819x_led",
        .id                     = 4,
        .dev            = {
                .platform_data = &rtl_pdata_led5g
        },
};
#endif
#endif
#ifdef CONFIG_EFM_EXTENDER_GIGA
static struct rtl819x_gpio_platdata rtl_pdata_ext2g_best = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext2g_best",
};
static struct rtl819x_gpio_platdata rtl_pdata_ext2g_good = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext2g_good",
};
static struct rtl819x_gpio_platdata rtl_pdata_ext2g_low = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext2g_low",
};
static struct rtl819x_gpio_platdata rtl_pdata_ext2g_bad = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext2g_bad",
};

static struct rtl819x_gpio_platdata rtl_pdata_ext5g_best = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext5g_best",
};
static struct rtl819x_gpio_platdata rtl_pdata_ext5g_good = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext5g_good",
};
static struct rtl819x_gpio_platdata rtl_pdata_ext5g_low = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext5g_low",
};
static struct rtl819x_gpio_platdata rtl_pdata_ext5g_bad = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "ext5g_bad",
};
#if !defined(CONFIG_SERIAL_RTL_UART1_PINMUX1)
static struct platform_device rtl_led_dev_ext2g_best = {
        .name           = "rtl819x_led",
        .id                     = 5,
        .dev            = {
                .platform_data = &rtl_pdata_ext2g_best
        },
};
static struct platform_device rtl_led_dev_ext2g_good = {
        .name           = "rtl819x_led",
        .id                     = 6,
        .dev            = {
                .platform_data = &rtl_pdata_ext2g_good
        },
};
static struct platform_device rtl_led_dev_ext2g_low = {
        .name           = "rtl819x_led",
        .id                     = 7,
        .dev            = {
                .platform_data = &rtl_pdata_ext2g_low
        },
};
static struct platform_device rtl_led_dev_ext2g_bad = {
        .name           = "rtl819x_led",
        .id                     = 8,
        .dev            = {
                .platform_data = &rtl_pdata_ext2g_bad
        },
};
static struct platform_device rtl_led_dev_ext5g_best = {
        .name           = "rtl819x_led",
        .id                     = 9,
        .dev            = {
                .platform_data = &rtl_pdata_ext5g_best
        },
};
static struct platform_device rtl_led_dev_ext5g_good = {
        .name           = "rtl819x_led",
        .id                     = 10,
        .dev            = {
                .platform_data = &rtl_pdata_ext5g_good
        },
};
static struct platform_device rtl_led_dev_ext5g_low = {
        .name           = "rtl819x_led",
        .id                     = 11,
        .dev            = {
                .platform_data = &rtl_pdata_ext5g_low
        },
};
static struct platform_device rtl_led_dev_ext5g_bad = {
        .name           = "rtl819x_led",
        .id                     = 12,
        .dev            = {
                .platform_data = &rtl_pdata_ext5g_bad
        },
};
#endif
#endif
#ifdef CONFIG_EFM_RING_GIGA
static struct rtl819x_gpio_platdata rtl_pdata_led_red = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "led_red",
};

static struct rtl819x_gpio_platdata rtl_pdata_led_blue = {
        .flags          = RTL819X_GPIO_ACTLOW,
        .name           = "led_blue",
};
#if !defined(CONFIG_SERIAL_RTL_UART1_PINMUX1)
static struct platform_device rtl_led_dev_red = {
        .name           = "rtl819x_led",
        .id                     = 13,
        .dev            = {
                .platform_data = &rtl_pdata_led_red
        },
};
static struct platform_device rtl_led_dev_blue = {
        .name           = "rtl819x_led",
        .id                     = 14,
        .dev            = {
                .platform_data = &rtl_pdata_led_blue
        },
};
#endif
#endif
...
#endif
#ifdef CONFIG_EFM_EXTENDER_GIGA
static struct rtl819x_gpio_platdata rtl_pdata_btn3 = {
	.flags		= RTL819X_GPIO_ACTLOW,
	.name		= "wps2g_btn",
};

static struct platform_device rtl_btn_dev3 = {
	.name		= "rtl819x_btn",
	.id			= 2,
	.dev		= {
		.platform_data = &rtl_pdata_btn3
	},
};
static struct rtl819x_gpio_platdata rtl_pdata_btn4 = {
	.flags		= RTL819X_GPIO_ACTLOW,
	.name		= "wps5g_btn",
};

static struct platform_device rtl_btn_dev4 = {
	.name		= "rtl819x_btn",
	.id			= 3,
	.dev		= {
		.platform_data = &rtl_pdata_btn4
	},
};
#endif
/* Other devices */
...
#ifdef CONFIG_EFM_EXTENDER_GIGA
#if !defined(CONFIG_SERIAL_RTL_UART1_PINMUX1)
	&rtl_led_dev_ext2g_best,
	&rtl_led_dev_ext2g_good,
	&rtl_led_dev_ext2g_low,
	&rtl_led_dev_ext2g_bad,
	&rtl_led_dev_ext5g_best,
	&rtl_led_dev_ext5g_good,
	&rtl_led_dev_ext5g_low,
	&rtl_led_dev_ext5g_bad,
#endif
#endif
#ifdef CONFIG_EFM_RING_GIGA
#if !defined(CONFIG_SERIAL_RTL_UART1_PINMUX1)
...
#ifdef CONFIG_EFM_PATCH
        rtl_pdata_led2g.gpio = BSP_WL2G_LED_PIN;
        rtl_pdata_led5g.gpio = BSP_WL5G_LED_PIN;
#endif
#ifdef CONFIG_EFM_EXTENDER_GIGA
	rtl_pdata_ext2g_best.gpio = BSP_2G_BEST_PIN;
	rtl_pdata_ext2g_good.gpio = BSP_2G_GOOD_PIN;
	rtl_pdata_ext2g_low.gpio = BSP_2G_LOW_PIN;
	rtl_pdata_ext2g_bad.gpio = BSP_2G_BAD_PIN;
	rtl_pdata_ext5g_best.gpio = BSP_5G_BEST_PIN;
	rtl_pdata_ext5g_good.gpio = BSP_5G_GOOD_PIN;
	rtl_pdata_ext5g_low.gpio = BSP_5G_LOW_PIN;
	rtl_pdata_ext5g_bad.gpio = BSP_5G_BAD_PIN;
#endif
#ifdef CONFIG_EFM_RING_GIGA
        rtl_pdata_led_red.gpio = BSP_RED_LED_PIN;
        rtl_pdata_led_blue.gpio = BSP_BLUE_LED_PIN;
#endif
#if !defined(CONFIG_I2C_DESIGNWARE_PLATFORM)//joyce
#if !defined(CONFIG_P3_GPIO)
...
#endif
#ifdef CONFIG_EFM_EXTENDER_GIGA
	rtl_pdata_btn3.gpio = BSP_WPS_BTN_2G_PIN;
	rtl_pdata_btn4.gpio = BSP_WPS_BTN_5G_PIN;
#endif
