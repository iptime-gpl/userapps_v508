...
static unsigned int help(struct sk_buff *skb, struct nf_conn *ct,
			 ...
			 char *bnet_data)
{
	...
	pdata =  bnet_data;
        ...
        nf_nat_mangle_tcp_packet(skb, ct, ctinfo, protoff, addrpos, addrlen,
...
static void fini(void)
{
	...
	RCU_INIT_POINTER(nf_nat_bnet_hook, NULL);
	synchronize_rcu();
}
...
static int __init init(void)
{
	...
	RCU_INIT_POINTER(nf_nat_bnet_hook, help);
	return 0;
