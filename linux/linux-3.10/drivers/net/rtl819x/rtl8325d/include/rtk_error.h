...
typedef enum rt_error_code_e
{
    ...
    RT_ERR_L2_FWDTBL_FULL,                          /* 0x00060014, forwarding table is full                                           */
    ...
    RT_ERR_FILTER_ACTION,                           /* 0x00070005, action doesn't consist to entry type or action not supported                                */
    ...
    RT_ERR_QOS_SEL_PRI_GROUP,                       /* 0x000d000b, invalid group of priority selection                                                 */
    RT_ERR_QOS_DEI,                                 /* 0x000d000c, invalid DEI value                                            */
    ...
    /* 0x1200 for jumbo */
    RT_ERR_JUMBO_FRAME_SIZE = 0x00120000,               /* Jumbo frame size not supported */

    RT_ERR_END                                       /* The symbol is the last symbol                                                  */
} rt_error_code_t;
