...
extern int RTL8309M_init_switch_mode(void);
extern int32 smiInit(uint32 port, uint32 pinMDC, uint32 pinMDIO);

void init_8309m(void)
{
#if defined(CONFIG_RTL_8197F)
        #undef GPIO_RESET
        #define GPIO_RESET      29              // GPIO_H5
        int ret, i;
        int loop;
        #if defined(REINIT_SWITCH_CORE)
        if (rtl865x_duringReInitSwtichCore == 1)
        ...
        REG32(PIN_MUX_SEL2) = (REG32(PIN_MUX_SEL2) & ~(0x000F0000));    //REMOVE Jtag. need to find out
#endif
        ...
        for (i=0; i<3; i++)
        {
                ...
                for (loop=10; loop>=0; loop--) //8309m need 10s for eeprom autoload
                        mdelay(1000);
                ...
                smiInit(GPIO_PORT_C, 2, 3);
                mdelay(1000);
                ret = RTL8309M_init_switch_mode();
                if (ret == 0)
                        break;
        }
#if defined(CONFIG_RTK_VLAN_SUPPORT)|| defined(CONFIG_RTL_DNS_TRAP) || defined(CONFIG_RTL_VLAN_8021Q)
...
#ifdef CONFIG_EFM_EXTENDER_GIGA	/*h.y.kim : SET LAN LED for custom LED register*/
	rtl8651_setAsicEthernetPHYReg(PORT0_RGMII_PHYID, 31, 0x0D04 );
	rtl8651_getAsicEthernetPHYReg(PORT0_RGMII_PHYID, 16, &data );
	rtl8651_setAsicEthernetPHYReg(PORT0_RGMII_PHYID, 16, (data | 0x1B) );
	rtl8651_setAsicEthernetPHYReg(PORT0_RGMII_PHYID, 31, 0 );
#endif
...
#if defined(CONFIG_RTL819X_GPIO) && (defined(CONFIG_RTL_8367R_SUPPORT) || defined(CONFIG_RTL_83XX_SUPPORT) || defined(CONFIG_RTL_8309M_SUPPORT)) && !defined(CONFIG_OPENWRT_SDK)
...
#if defined(CONFIG_RTL_8197F) && defined(CONFIG_RTL_8309M_SUPPORT)
void init_8197f_8309m_p0(void)
{
        REG32(PCRP0) = (REG32(PCRP0) & ~(ExtPHYID_MASK)) | (5 << ExtPHYID_OFFSET)
                                        | MIIcfg_RXER |  EnablePHYIf | MacSwReset;
        ...
        REG32(P0GMIICR) = (REG32(P0GMIICR) & ~(3<<23)) | (LINK_MII_PHY<<23);
	...
	|| defined(CONFIG_RTL_8197F)) && !(defined(CONFIG_RTL_8367R_SUPPORT) || defined(CONFIG_RTL_83XX_SUPPORT) || defined(CONFIG_RTL_8309M_SUPPORT))
...
int32 rtl865x_initAsicL2(rtl8651_tblAsic_InitPara_t *para)
{
	...
	*/
	...
	#ifdef CONFIG_RTL_8309M_SUPPORT //for zion 97FS port4 LED: LED mode
                REG32(PIN_MUX_SEL14) = 0;
        #endif
	...
	*/
	...
	//WRITE_MEM32(PIN_MUX_SEL_2, 0);
...
#if defined(CONFIG_RTL_8198) || defined(CONFIG_EFM_PATCH)
       WRITE_MEM32(PCRP0, READ_MEM32(PCRP0) | ((0<<ExtPHYID_OFFSET)|EnablePHYIf|MacSwReset|AcptMaxLen_9K) ); /* Jumbo Frame */
       WRITE_MEM32(PCRP1, READ_MEM32(PCRP1) | ((1<<ExtPHYID_OFFSET)|EnablePHYIf|MacSwReset|AcptMaxLen_9K) ); /* Jumbo Frame */
       WRITE_MEM32(PCRP2, READ_MEM32(PCRP2) | ((2<<ExtPHYID_OFFSET)|EnablePHYIf|MacSwReset|AcptMaxLen_9K) ); /* Jumbo Frame */
       WRITE_MEM32(PCRP3, READ_MEM32(PCRP3) | ((3<<ExtPHYID_OFFSET)|EnablePHYIf|MacSwReset|AcptMaxLen_9K) ); /* Jumbo Frame */
       WRITE_MEM32(PCRP4, READ_MEM32(PCRP4) | ((4<<ExtPHYID_OFFSET)|EnablePHYIf|MacSwReset|AcptMaxLen_9K) ); /* Jumbo Frame */
#else
       ...
       WRITE_MEM32(PCRP4, READ_MEM32(PCRP4) | ((4<<ExtPHYID_OFFSET)|EnablePHYIf|MacSwReset) ); /* Jumbo Frame */
		...
		rtl865xC_setAsicEthernetMIIMode(5, LINK_RGMII); //port 5  GMII/MII MAC auto mode
                ...
                REG32(PCRP5) = 0 | (0x5<<ExtPHYID_OFFSET) |      //JSW@20100309:For external 8211BN GMII ,PHYID must be 5
                                EnForceMode| ForceLink|ForceSpeed1000M |ForceDuplex |
                                MIIcfg_RXER | AcptMaxLen_9K | EnablePHYIf | MacSwReset ;
#else
...
#elif defined(CONFIG_RTL_8197F) && defined(CONFIG_RTL_8309M_SUPPORT)
        init_8197f_8309m_p0();
...
#if (defined(CONFIG_RTL_8211DS_SUPPORT)&&defined(CONFIG_RTL_8197D)) || defined(CONFIG_RTL_8367R_SUPPORT) || defined(CONFIG_RTL_8370_SUPPORT) || defined(CONFIG_RTL_8325D_SUPPORT) || defined(CONFIG_RTL_83XX_SUPPORT) || defined(CONFIG_RTL_8309M_SUPPORT)
	P0phymode = 3;
	...
	else //external phy
	{
		...
		if(P0miimode==3)
		{
			...
			#if defined(CONFIG_RTL_8367R_SUPPORT) || defined(CONFIG_RTL_8370_SUPPORT) || defined(CONFIG_RTL_8325D_SUPPORT) || defined(CONFIG_RTL_83XX_SUPPORT) || defined(CONFIG_RTL_8309M_SUPPORT)
			P0txdly = 1;
			P0rxdly = 5;
			#endif
...
/* 	system clock = 50MHz --> token=0x40, tick=0x0b, l2=3*token=0xC0
	...
	#if defined(PATCH_GPIO_FOR_LED) && !defined(CONFIG_RTL_8367R_SUPPORT) && !defined(CONFIG_RTL_83XX_SUPPORT) && !defined(CONFIG_RTL_8309M_SUPPORT)
