...
#if PHYDM_TDMA_DIG_SUPPORT
	if(pDM_Odm->original_dig_restore == 0) {
		Total_CCA_Cnt = pDM_Odm->FalseAlmCnt_Acc.Cnt_CCA_all_1sec[TDMA_DIG_HIGH_STATE];
		Total_FA_Cnt  = pDM_Odm->FalseAlmCnt_Acc.Cnt_all_1sec[TDMA_DIG_HIGH_STATE];
	} else
#endif
	{
