/* $Id: upnpdescgen.c,v 1.2 2016/12/12 07:13:50 mt7623 Exp $ */
/* MiniUPnP project
...
#ifdef USE_MINIUPNP
char ROOTDEV_FRIENDLYNAME[128] = "Router";
char ROOTDEV_MANUFACTURER[128] = OS_NAME;
char ROOTDEV_MANUFACTURERURL[128] = OS_URL;
char ROOTDEV_MODELNAME[128] = "Router";
char ROOTDEV_MODELDESCRIPTION[128] = "Router";
char ROOTDEV_MODELURL[128] = OS_URL;

char WANDEV_MANUFACTURERURL[128] = OS_URL;
char WANDEV_MODELURL[128] = OS_URL;
char WANCDEV_MODELURL[128] = OS_URL;
#endif
...
#ifdef USE_MINIUPNP
				if (use_ext_dynamic_ip) {
					char wan_name[20];

					upnp_get_wan_name(wan_name);
					get_wan_ip(wan_name, use_ext_ip_addr);

					if (!strcmp(use_ext_ip_addr, ""))
						strncpy(use_ext_ip_addr, "0.0.0.0", INET_ADDRSTRLEN);
